...
from .utils import (_build_cartesian_grid, _compute_single_basis_overlap_cart, _parse_method,
                    _radial_extent,
                    _build_radial_grid,
...
def compute_overlap(
    ...
    *,
    ...
    n_cartesian_grid: int
        The number of points in the Cartesian quadrature grid. Must be >= 8.
    initial_r_max: float
    ...
    if isinstance(ri_basis_set, RIBasis):
        return _compute_single_basis_overlap_cart(
            ri_basis_set,
            metric_method,
    ...
    s_blocks = [
        _compute_single_basis_overlap_cart(
            basis,
            metric_method,
            n_cartesian_grid=n_cartesian_grid,
            initial_r_max=initial_r_max,
